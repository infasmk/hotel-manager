...
import { Hotel, Lock, ShieldCheck, Eye, EyeOff, ArrowRight, Sparkles } from 'lucide-react';
...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        // Using a dedicated admin email for the single-password flow
            ...
            <div className="w-full max-w-md bg-gray-900 rounded-[3rem] shadow-2xl border border-white/5 overflow-hidden relative z-10 animate-in fade-in zoom-in-95 duration-700">
                <div className="p-10 sm:p-12">
                    ...
                    <form className="space-y-8" onSubmit={handleLogin}>
                        ...
                        {error && (
                            <div className="flex items-center gap-3 p-5 bg-rose-500/10 border border-rose-500/20 rounded-2xl animate-shake">
                    ...
                    <div className="mt-12 pt-8 border-t border-white/5 text-center">
                        <p className="text-[9px] font-black text-gray-600 uppercase tracking-[0.4em]">Cloud Security Verified by Supabase</p>
                    </div>
                </div>
            </div>
        </div>

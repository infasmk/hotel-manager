            ...
            <div className="bg-rose-500/10 border border-rose-500/20 p-6 sm:p-10 rounded-[2.5rem] flex items-center justify-between shadow-2xl">
                <div className="flex items-center gap-5">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">{filteredExpenses.length} Debit Records</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-2 px-6 py-4 text-xs font-black rounded-2xl transition-all border uppercase tracking-[0.2em] ${filterByDate ? 'bg-rose-500 text-white border-rose-500 shadow-lg shadow-rose-500/20' : 'bg-white/5 border-white/10 text-gray-500 hover:text-white'}`}
                        >
                            <Filter size={16} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {isLoading ? (
                    ...
                    <div className="col-span-full py-24 text-center">
                        <p className="text-[11px] font-black text-gray-700 uppercase tracking-[0.5em]">No Debit Records Found</p>
                    </div>
                )}
            </div>

            <Modal isOpen={isModalOpen} onClose={handleCloseModal} title={currentExpense?.id ? 'Correction' : 'Log Expense'}>
                <form onSubmit={handleSave} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Net Value (₹)</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-gray-500 uppercase tracking-widest ml-1">Method</label>
                            <div className="relative">
